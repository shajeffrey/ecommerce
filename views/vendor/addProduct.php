                        ...
                        ?>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" class="form-control input-update" required name="prodInv" id="prodInv" value="">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
