...
<nav class="navbar navbar-expand-lg navbar-dark " style="background-color:#6A0DAD;font-size: 19px;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
            <a class="nav-link" href="vendorLogin.php">Login <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="vendorRegister.php">Register</a>
        </li>
        <!--
        ...
        <ul class="navbar-nav ">
        <li class="nav-item ">
            <a class="nav-link mr-auto" href="../user/userLogin.php">A User? <span class="sr-only">(current)</span></a>
        </li>
        </ul>
