...
<div class="container-fluid ">
    ...
    <div class="row">
        ...
        <h2 style="color:#007dd6;" class="mb-4">Orders Cancelled</h2>
        </div>

        <div class="col-4 text-center">
            <a  href="orderCancel.php" style="background-color:#007dd6; color:white;" class="btn inactiveLink2">View Cancelled Orders</a> 
        </div>
    ...
    <table style="background-color: rgba(255,255,255,0.1); box-shadow: 0px 0px 5px 0px rgba(0, 0, 0, 0.2);"  class="table text-center table-bordered">
        ...
        <tr class="tr">
            ...
            <th style="width: 10%;">Cart Date</th>
            <th style="width: 10%;">Delete Date</th>
        </tr>
        </thead>
        <tbody>
        ...
        if($count>0)
        {
            ...
            while($cartRow=mysqli_fetch_assoc($cartList))
            {
                ...
                $orderID = $cartRow['orderID']; 
                    ...
                    $orderDate = $cartRow['orderDate'];
                    $deleteDate = $cartRow['deleteDate'];
        ...
        <?php
            ...
            else
            {
                ...
                echo "<tr> <td colspan='12' class='text-center'>No Orders Cancelled </td> </tr>";
            }
